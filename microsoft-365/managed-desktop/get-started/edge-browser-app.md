...
The password manager is disabled by default due but can be enabled upon customer request. Please file a support request and our service engineers can enable the setting in your environment. 
